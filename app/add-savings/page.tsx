...
export default function AddSavingsPage() {
    ...
    const alertMessage = "Savings added successfully!";
    ...
    return (
        <div className="z-50 flex flex-col items-center justify-center min-h-screen bg-chart-4 border-8 border-black font-mono relative">
